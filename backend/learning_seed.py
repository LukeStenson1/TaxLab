"""Default learning-center content. Seeded into the `learning_sections`
collection on first run. Admins can add / edit / hide / delete sections
afterward via the admin API, so this is only the starting set."""
